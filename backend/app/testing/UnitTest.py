...
class TestDpsCalculator(unittest.TestCase):
    ...
    def test_special_attack_simulation(self):
        """Special attacks should be used whenever energy is available."""
        params = {
            "combat_style": "melee",
            "strength_level": 99,
            "strength_boost": 0,
...
class TestMagicCalculator(unittest.TestCase):
    ...
    def test_tumekens_shadow_bonus(self):
        ...
        self.assertEqual(result_50["accuracy_bonus"], 0.5)  # 50% accuracy remains the same
